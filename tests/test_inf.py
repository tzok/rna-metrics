...
class TestINF:
    def setup_method(self):
        ...
        self.canonical1, self.non_canonical1, self.stacking1 = process_structure(self.pdb1)
        self.canonical2, self.non_canonical2, self.stacking2 = process_structure(self.pdb2)
    ...
    def test_inf_canonical(self):
        ...
        assert score == pytest.approx(1.0, abs=1e-4), "Canonical INF score should be 1.0"
    ...
    def test_inf_non_canonical(self):
        ...
        assert score == pytest.approx(0.9375, abs=1e-4), "Non-canonical INF score should be 0.9375"
    ...
    def test_inf_stacking(self):
        ...
        assert score == pytest.approx(0.9506, abs=1e-4), "Stacking INF score should be 0.9506"
    ...
    def test_inf_all(self):
        ...
        assert score == pytest.approx(0.9570, abs=1e-4), "All interactions INF score should be 0.9570"
